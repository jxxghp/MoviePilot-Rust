...
```text
dist/moviepilot_rust-0.1.0-cp311-abi3-macosx_11_0_arm64.whl
dist/moviepilot_rust-0.1.0.tar.gz
```
...
推送 `v*` tag 会触发 GitHub Actions，自动构建 Linux、macOS、Windows wheel 和 sdist，并发布到 PyPI。
